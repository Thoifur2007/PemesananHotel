...
if (isset($_POST['submit'])) {
    ...
    $sql= "select * FROM admin where usernamee='$username' and pass='$password'";
...
<div class="min-h-screen bg-gray-50/50">
  ...
  <div class="p-4 xl:ml-80">
          ...
          <nav aria-label="breadcrumb" class="w-max">
            <ol class="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
              ...
              <li class="flex items-center text-blue-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
                <p class="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">Data Kamar</p>
              </li>
            </ol>
          </nav>
          <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-gray-900">Data Kamar</h6>
        </div>
      ...
      <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div class="p-4 text-right">
            ...
            <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">3,700</h4>
          </div>
          <div class="border-t border-blue-gray-50 p-4">
            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
    ...
    <br>
    <a class="btn btn-success mt-3" href="tambahkamar.php">tambah kamar </a>
  <table class="table mt-5">
  <thead>
    <tr>
      <th scope="col">jenis kamar</th>
      <th scope="col">hargakamar</th>
...
?>
  <tr>
      ...
      <td>
        <a class="btn btn-info badge p-2"href="edit kamar.php?id=<?php echo $row['id_kamar'];?>">edit</a>
        <a class="btn btn-danger badge p-2" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $no ?>">delete</a>
      </td>
    </tr>
<?php }?>
<div class="modal fade" id="exampleModal<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="Hapus kamar.php" method="POST">
      <div class="modal-body">
        <h4>yakin di hapus?</h4>
        <p>kamar :<span class="text-danger"><?php echo $row['jeniskamar'];?></span></p>
      </div>
