...
<div class="min-h-screen bg-gray-50/50">
  <aside class="bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
    ...
    <div class="m-4">
      <ul class="mb-4 flex flex-col gap-1">
        <li>
          <a aria-current="page" class="active" href="data admin.php">
  ...
  <div class="p-4 xl:ml-80">
          ...
          <nav aria-label="breadcrumb" class="w-max">
            <ol class="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
              ...
              <li class="flex items-center text-blue-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
                <p class="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">Data Admin</p>
              </li>
            </ol>
          </nav>
          <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-gray-900">Data Admin</h6>
        </div>
      ...
      <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div class="p-4 text-right">
            ...
            <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">3,750</h4>
          </div>
          <div class="border-t border-blue-gray-50 p-4">
            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
    ...
    <br>
    <a class="btn btn-success mt-3" href="tambah admin.php">tambah admin </a>
...
?>
    <tr>
      ...
      <td>
        <a class="btn btn-info badge p-2"href="edit data.php?id=<?php echo $row['id_admin'];?>">edit</a>
...
<div class="modal fade" id="exampleModal<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="Hapus admin.php" method="POST">
      <div class="modal-body">
        <h4>yakin di hapus?</h4>
        <p>username :<span class="text-danger"><?php echo $row['usernamee'];?></span></p>
      </div>
